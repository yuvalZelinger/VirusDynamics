...
namespace VirusDynamic_UI
{
    public partial class MainForm : Form
    {
        ...
        private void Start_Click(object sender, EventArgs e)
        {
            ...
            this.immunityTextBox.Visible = true;
            this.drugImmunityLabel.Visible = true;
            ...
            this.drugsNumberLabel.Visible = true;
            this.addDrugButton.Visible = true;
            //updateInfoLabels();
        }
        ...
        private void updateInfoLabels()
        {
            ...
            this.drugsNumberLabel.Text = "Drugs number: " + patient.DrugNumber;
        ...
        {
            dragNumber++;
            this.drugsNumberLabel.Text = "Drugs number: " + dragNumber;
            if (patient != null)
            {
                patient.addDrug();
            }
